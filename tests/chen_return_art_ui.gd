...
func _run() -> void:
	...
	await restore_stage("return-meeting"); screen._close_drawer(); await _frames()
	...
	var saved := _session._save.library.read_entry("auto/first_debt_dragon_search")
...
func shot(stage: String) -> void:
	...
	var directory := "res://docs/qa/chen-return-v31/"
