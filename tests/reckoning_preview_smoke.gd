...
func run() -> void:
	...
	var okay: bool = session.content_version == 29 and before.current_night_index == 11 and before.game_minutes == 0 and before.cash == 195 and visitor != null and visitor.customer_id == "fd_seller"
	...
	okay = okay and session._save.library.path == "user://tests/v29_preview/seller_library.json"
