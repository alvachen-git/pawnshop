...
static func rng(seed_value: int, key: String) -> RandomNumberGenerator:
	...
	key = key.replace("porcelain_release/", "first_debt_recovery/").replace("porcelain_unified/", "first_debt_unified/").replace("first_debt_recovery_release/", "first_debt_recovery/").replace("bangle_unified/", "first_debt_unified/").replace("bangle_market_ten/", "watch_ten/").replace("pearl_market_ten/", "watch_ten/").replace("named_wealthy_ten/", "watch_ten/").replace("watch_patterns_ten/", "watch_ten/").replace("watch_negotiation_ten/", "watch_ten/").replace("watch_market_ten/", "watch_ten/")
