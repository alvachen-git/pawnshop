...
static func build(state: RunState) -> Dictionary:
	...
	if state.run_definition_id in ["first_debt_open", "first_debt_reckoning", "first_debt_dragon_search", "first_debt_unified", "bangle_unified", "first_debt_recovery", "first_debt_recovery_release"]: result.debt_compensation = 0
