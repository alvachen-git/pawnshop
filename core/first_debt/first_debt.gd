...
static func revised(s: RunState) -> bool:
	return s.run_definition_id in ["first_debt_reckoning", "first_debt_dragon_search", "first_debt_unified", "bangle_unified", "porcelain_unified", "camera_unified", "porcelain_release", "first_debt_recovery", "first_debt_recovery_release"]
