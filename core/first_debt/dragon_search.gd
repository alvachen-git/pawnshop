...
static func enabled(s: RunState) -> bool:
	return s.run_definition_id in [RUN, "first_debt_unified", "bangle_unified", "porcelain_unified", "gramophone_unified", "gramophone_release", "preopen_recycler", "silver_market", "camera_unified", "porcelain_release", "first_debt_recovery", "first_debt_recovery_release"]
