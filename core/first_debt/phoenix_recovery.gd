...
static func enabled(s: RunState) -> bool:
	return s.run_definition_id in ["gramophone_unified", "gramophone_release", "preopen_recycler", "silver_market", "qingbang_release", "first_debt_merit", "first_debt_merit_balance", "first_debt_merit_release", "camera_unified", "porcelain_release", "first_debt_recovery", "first_debt_recovery_release"]
