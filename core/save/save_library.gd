...
const MANIFESTS := ["res://data/market_familiar_manifest.json", "res://data/market_seven_manifest.json", "res://data/familiar_early_manifest.json", "res://data/familiar_manifest.json", "res://data/mirror_chapter_manifest.json", "res://data/preparation_manifest.json", "res://data/integrated_manifest.json", "res://data/content_manifest.json", "res://data/four_night_manifest.json", "res://data/seven_night_manifest.json", "res://data/opening_manifest.json", "res://data/legacy/content_v9.json", "res://data/legacy/content_v10_released.json", "res://data/legacy/content_v10.json", "res://data/legacy/content_v10_100_300.json", "res://data/legacy/content_v11.json"]
...
const NAMES := {"market_familiar": "鬼市当铺 · 生意与故人", "market_seven": "鬼市当铺 · 生意与旧事", "familiar_early": "鬼市当铺 · 熟客新约", "familiar_seven": "鬼市当铺 · 熟客往来", "mirror_chapter": "鬼市当铺 · 镜中旧事", "prepared_seven": "七夜 · 开铺准备", "integrated_seven": "鬼市当铺 · 七夜", "p0_variety": "三夜原型", "p0_room": "三夜原型（旧版）", "ordinary_four": "四夜经营", "ordinary_seven": "七夜经营", "opening_v01": "开场剧情"}
