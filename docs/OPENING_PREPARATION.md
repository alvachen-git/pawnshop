...
2026-09-07：v15新开局从第二夜起开放。第一夜保留开场流程；旧局继续原规则。当前默认v21继承本页准备规则，v15独立入口仍保留；当前运行与存档见 [当前开发规格](CURRENT_SPEC.md)。
...
- 当前默认标题入口使用版本21，继承 `variety.preparation_version = 1`。版本15的独立场景保留，历史版本继续通过存档库读取。
