...
- 实施基线：`00864844ae00aa2f0adf3ef825d091145c236ae7`。推送时先整合主菜单，再整合 `main` 的 `548ec8ab9af189741bffc4ec73ae599bf9955fed`（已上线普通交易v10），保留四夜独立入口。
...
- 实施前v10测试快照与已上线v10分别保留配置：前者保留急迫处境等待规则，后者保留职业等待时限及已上线议价文案。四夜v11沿用负责人测试时的编排与等待规则。来源展示、耐心提示、来源调查费用展示与新增回归测试已共同整合。
...
最终整合已上线普通交易v10后，完整验证 **81项全部通过**，记录在 `.artifacts/four-merge-validation-05/results.json`。其中四夜及旧版兼容检查42,532项断言，整合三夜16,976项，冻结v10检查17,079项，均0失败。新增来源窗口、来源跨进程、议价与来源组合测试也全部通过。
