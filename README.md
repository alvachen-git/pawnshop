...
新增独立的 **当铺成长 v25**：一级鉴物台、陈列柜与买家、第十七柜探索、完整设施场景，以及小箭头和默认淡入淡出。双击 `启动当铺成长.cmd`，或查看[启动与试玩说明](docs/SHOP_GROWTH_PLAYTEST.md)、[合并验证](docs/SHOP_GROWTH_INTEGRATION.md)。原默认入口与已有存档保留。

默认新游戏为 **v26 镜中重逢**：保留十夜经营、阿七、命灯与寝屋，铜镜正式对质改为双人逐句对白、固定概率交涉和四种收尾。丈夫在妻儿去世前另组家庭；逼问或打圆场决定其反应，激怒后可劝解或让女子杀夫。能力变化及铜镜怨气只在结局完成后通知。可暂缓或完全不处理，第十夜仍结束试玩。详见 [v26完整启动与试玩说明](docs/MIRROR_REUNION_V26.md)。

线上原有命灯版及夜客规则保留独立内容与存档。需要新开命灯版时运行 `godot --path . res://scenes/life_lamp_start.tscn`；读取已有命灯存档仍按原规则继续。

当前规格与待确认分歧统一见 [当前开发规格](docs/CURRENT_SPEC.md)。默认v26保留线上v23已整合的职业赎回、生计背景与寝屋铜镜反馈；原v21夜客和阿七七夜版使用各自冻结规则。第七夜阿七收尾后不额外叠加墙镜异象。

新增商品与行家复核版作为独立七夜入口保留，包含银戒指、银锁、折扇、茶盏及验配出售；启动方式见 [商品与行家说明](docs/GOODS_EXPERTISE.md)。库存详情统一精简为已知品相要点。

旧版本内容与存档保留原规则，v19经营整合、v20职业赎回和v21商品复核成果继续包含在新局中。换物不改变原票本金、赎金、期限或原主赎回概率；两类阴客与通用辨生死在对应v22、v23及新默认v26中生效。
