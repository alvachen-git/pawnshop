...
固定柜台式 2D 当铺经营与规则恐怖游戏。当前整合版默认使用v12卖货内容，保留v11四夜样板：默认 `p0_variety` 保留三夜原型，新增独立 `ordinary_four` 四夜普通经营样板。支持八类随机人物、专属鉴定、来源核验、证据议价、一次性贬低、原主回访与寝屋流程。另有独立的 **v13七夜普通经营局**，包含每夜6位潜在新客、16种来访处境、准备行动、限时钢笔收货链及3夜活当回访。七夜剧情与第21/49夜还本系统仍未制作。
