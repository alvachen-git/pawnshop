...
默认新游戏使用 **v19七夜经营整合版**：开场、现有铜镜章节、开铺准备、陆掌眼动态收货、第六夜钢笔预约、两条熟客往来及提前赎簪可以在同一局体验。库存、账本和卖货货单增加周转提示，区分现银、待结息费、现货占款与在当本金。启动、复现种子和测试步骤见 [整合版说明](docs/COMPLETE_SEVEN.md)。铜镜内容沿用原章，见 [铜镜第一章说明](docs/MIRROR_CHAPTER.md)。
