...
默认新游戏为 **v22 泣血铜镜：辨生死与两类阴客**，基于本地 v21 商品复核七夜版。铜镜每次5分钟辨认柜前来客是否为活人，可反复使用；第四夜加入不许验货的阴客，第五至第六夜加入付80银元调换抵押物的阴客。第一章补足女主人生活片段，保持七夜调查与三种阶段态度。详见 [v22试玩与规则](docs/LIVING_MIRROR_V22.md)。
